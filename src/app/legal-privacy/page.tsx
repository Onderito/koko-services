...
import { contactEmail, legalPostalCode } from "../data/site-config";

export default function LegalNotice() {
  return (
    <div className="px-6 md:px-20 py-32 max-w-5xl mx-auto text-[#404040]">
      ...
      <section className="space-y-6">
        ...
        <div>
          ...
          <p>Your personal information is collected through forms, such as:</p>
        ...
        <div>
          ...
          <p className="mt-2">
            ...
            <br /> Postal code: {legalPostalCode}
            <br /> Email:{" "}
            <a
