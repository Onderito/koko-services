              ...
              <div className="mt-6 border-t border-[#EFEFEF] pt-6">
                <div className="flex justify-center items-center w-full gap-4">
                  <Link
                    ...
                    scroll={true}
                    href={card.link}
                    className="inline-flex w-[48%] items-center justify-center rounded-xl border border-[#DADADA] bg-white px-5 py-3 text-center font-manrope-bold text-[14px] tracking-[-0.01em] text-[#404040] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#F7F7F7]"
                  >
                    Explore more
