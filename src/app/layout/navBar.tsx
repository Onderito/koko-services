...
export default function NavBar() {
    ...
    return (
        <nav className="sticky top-5 z-50">
            <div className="flex justify-center items-center gap-20 bg-white/80 rounded-3xl px-2 border-[0.5px] border-[#E5E5E5] w-fit mx-auto h-16 md:h-20 backdrop-blur-xs">
                {/* Logo */}
                ...
                <button className='text-[16px] font-manrope-bold text-white bg-[#23C063] px-8 rounded-2xl h-[52px] cursor-pointer'>Contact us</button>
