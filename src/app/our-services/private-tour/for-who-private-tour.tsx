  ...
  return (
    <div ref={containerRef} className="mb-20 container">
      ...
      <p className="body-text text-center mt-4 ">
        Custom private tours on the French Riviera—flexible routes, local
        insights, and zero logistics.
      </p>
      ...
      >
        ...
        >
          ...
          <p className="body-text text-center mt-4">
            See the must-sees without stress: tailored route, photo stops, café
            breaks, and a bilingual driver-guide sharing local tips.
          </p>
        </div>
        ...
        >
          ...
          <p className="body-text text-center mt-4">
            Old towns, perched villages, museums, artisan stops—Èze, Antibes,
            Saint-Paul-de-Vence and more, at your own pace.
          </p>
        </div>
        ...
        >
          ...
          <p className="body-text text-center mt-4">
            Comfortable vehicle, flexible timing, beach or village vibes, snack
            pauses—everyone enjoys the day, logistics handled.
          </p>
        </div>
      </div>
    </div>
