        ...
        <div className="min-h-[70vh] mt-10 lg:min-h-[80vh]">
            ...
            <div className="flex flex-col xl:flex-row justify-center items-center gap-10">
                <div className="xl:w-2/3">
                    <h1 className="font-manrope-bold text-[44px] leading-[40px] tracking-[-2px] md:text-[64px] md:leading-[56px] xl:text-[80px] xl:tracking-[-5%] xl:leading-[72px]  ">Private Tour </h1>
                    <p className="font-manrope-regular text-[18px] leading-[26px] md:text-[20px] mt-4 xl:mt-6">Your exclusive tour of the French Riviera. Discover the Côte d&apos;Azur at your own pace with a dedicated private driver-guide for a half-day or full-day experience.</p>
