        ...
        <div className="min-h-[70vh] mt-10 lg:min-h-[80vh]">
            ...
            <div className="flex flex-col xl:flex-row justify-center items-center gap-10">
                <div className="xl:w-2/3">
                    ...
                    <p className="body-text mt-4 xl:mt-6">Your exclusive tour of the French Riviera. Discover the Côte d&apos;Azur at your own pace with a dedicated private driver-guide for a half-day or full-day experience.</p>
